...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    -- A physically checked-in guest holds the room until an explicit checkout,
    -- so overdue stays (check_out <= _date) must stay in the occupancy set.
    -- Date alone must never release a room.
