  ...
  SELECT jsonb_build_object(
    ...
    'active_booking_rooms', COALESCE((
      ...
      WHERE br.property_id = _property_id
        ...
        AND (
          -- PRIMARY: genuinely live occupancy, independent of the booked date window
          (br.status = 'active' AND br.actual_check_in IS NOT NULL)
          -- FALLBACK: reserved / date-window based visibility
