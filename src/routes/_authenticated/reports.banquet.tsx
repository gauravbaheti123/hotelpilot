...
import { billNo , eventRefShort } from "@/lib/billNumber";
...
function Page() {
  ...
  const load = useCallback(async () => {
    ...
    const out: Row[] = events.map((b) => ({
      _id: b.booking_id, bill_no: eventRefShort(b.banquet_number, b.booking_number), event_name: b.event_name ?? b.function_type,
